        ...
        while (true){
            ...
            switch (pilihan){
                case "C":
                    ...
                    if(status==true){
                        System.out.println("DATA BERHASIL DI TAMBAKAN");
                    }else {
                        System.out.println("NIM "+nim+" sudah ada di database");
                        System.out.println("GAGAL MENEMUKAN DATA BARU");
                    }
                    break;
                case "R":
                ...
                case "U":
                    ...
                    if (index >= 0){
                        ...
                        if(status==true){
                            ...
                            System.out.println("GAGAL MEMPERBARUI BATA");
                        }
                        System.out.println("---------------------------------------------");
                    }else {
                ...
                case "D":
                    ...
                    index = db.search(key);
                    if (index >= 0){
                        System.out.println("APAKAH ADA YAKIN AKAN MENGHAPUS DATA"+db.getData().get(index)+"? Y/N");
                        System.out.print("pilih  : ");
                        pilihan = sc.nextLine();
                        if (pilihan.equalsIgnoreCase("Y")){
                            status = db.delete(index);
                            if (status==true) {
                                System.out.println("BERHASIL DI HAPUAS");
                            }else {
                                System.out.println("GAGAL MENGHAPUAS DATA");
                            }
                        }
                    }else {
                        System.err.println("Mahasiswa dengan NIM: " + key + "tidak ada di database");
                ...
                case "X":
                    ...
                    System.out.println("APAKAH ANDA YAKIN AKAN KELUAR DARI APLIKASIH? Y/N");
                    System.out.print("Pilih  : ");
                    pilihan = sc.nextLine();
                    if (pilihan.equalsIgnoreCase("Y")){
                        System.exit(0);
